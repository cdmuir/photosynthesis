...
The `fit_aq_response()` function is the original version, but we are no longer updating it and may phase it out of future releases. Use `fit_aq_response2()` instead.
