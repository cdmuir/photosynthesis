...
#' \eqn{g_\mathrm{sw}}{g_sw} \tab \code{g_sw} \tab stomatal conductance to H2O \tab (\eqn{\mu}mol) / (m\eqn{^2} s) \tab converted from \eqn{g_\mathrm{sc}}{g_sc} \cr
#' \eqn{g_\mathrm{uw}}{g_uw} \tab \code{g_uw} \tab cuticular conductance to H2O \tab (\eqn{\mu}mol) / (m\eqn{^2} s) \tab converted from \eqn{g_\mathrm{uc}}{g_uc} \cr
