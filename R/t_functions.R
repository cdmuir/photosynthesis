...
#' @param b Linear coefficient to minmize residuals (Heskel et al. 2016)
...
#' @param Par_ref Parameter at reference temperature of 25 Celsius (Kruse et al. 2008)
#' 
...
#' @param Topt Optimum temperature of the process in Celsius (Medlyn et al. 2002)
#' 
#' @param dH Change in enthalpy of the reaction at 25 C in J mol-1 (Hobbs et al. 2013)
#' @param dCp Change in heat capacity of the enzyme between the enzyme-substrate
#' and enzyme-transition states in J mol-1 K-1 (Hobbs et al. 2013)
#' @param dG Change in Gibbs free energy of the reaction at 25 C in J mol-1 (Hobbs et al. 2013)
#' 
