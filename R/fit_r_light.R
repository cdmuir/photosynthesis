...
#' @param PPFD_lower Lower light intensity limit for estimating Rlight (Kok & Yin)
#' @param PPFD_upper Upper light intensity limit for estimating Rlight (Kok & Yin)
#' 
#' @param P Atmospheric pressure in kPa (Walker & Ort, 2015)
#' @param C_i_threshold Threshold C_i (in umol mol-1) to cut data to
#' linear region for fitting light respiration and GammaStar (Walker & Ort, 2015)
#'
...
#' and estimates of the coefficients. NOTE: if using C_i, the output value is technically C_istar. You
